...
// Нічого, бо всі умови повертають false
...
// 	let res2 = isFinite(result) ? `Результат ділення: ${result}` : `Не вірні вхідні дані`
...
// calcDivision(2, 5)
// calcDivision()
// calcDivision(2, 'Сашко')
// calcDivision(2, NaN)
// calcDivision(0)
// calcDivision(2, 0)
// calcDivision(Infinity)
...
// const arr = ['Sashko', [], 10, '10', 36]

// arr.forEach((e, i) => {
// 	if (e === 10) {
// 		console.log(`В мвсиві є число 10 в ячейці №${i}`)
// 	}
// })
