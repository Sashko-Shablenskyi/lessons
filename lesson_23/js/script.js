...
// function addLi(countLi = 5) {
// 	bodyElem.innerHTML = `<ul></ul>`
// 	let liList = ''
...
// 	const ul = bodyElem.querySelector("ul")
// 	ul.insertAdjacentHTML("beforeend", liList)
// }
// addLi(17)
...
// if (bodyElem.classList.contains('loaded')) {
...
// if (link) {
// 	const result = link.dataset.num

// 	// if (result < 200) {
// 	// 	link.classList.add('link--error')
// 	// }

// 	result < 200 ? link.classList.add('link--error') : null
// }